...
&& rm -rf Natch-Jsp  \
&& git clone https://github.com/denevell/Natch-Jsp.git && cd Natch-Jsp && git submodule update --init --recursive \
...
&& DISPLAY=:0 ANDROID_SDK_HOME=/android-sdk-linux ANDROID_HOME=/android-sdk-linux /android-sdk-linux/tools/emulator-x86 @testy & sleep 30 \
&& echo '=== grabing latest' \
&& cd /Natch-Android/ \ 
